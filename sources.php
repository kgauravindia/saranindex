        ...
        <div class="row g-3 align-items-center">
            ...
            <div class="col-md-6 text-md-end">
                <div class="d-flex flex-wrap gap-1.5 justify-content-md-end">
                    ...
                    <button type="button" class="btn btn-sm btn-light border rounded-pill px-3 py-1.5 filter-btn" data-filter="Fuel">Petroleum & Fuel</button>
                    <button type="button" class="btn btn-sm btn-light border rounded-pill px-3 py-1.5 filter-btn" data-filter="Hospital">Healthcare</button>
