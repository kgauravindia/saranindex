...
<div class="container py-4">
    ...
    <div class="bg-white p-3.5 rounded-4 shadow-sm border mb-4">
        <form action="search.php" method="GET" class="row g-3 align-items-end">
            ...
            <div class="col-lg-3 col-md-6">
                <label class="form-label small fw-bold text-muted mb-1">उपश्रेणी (Subcategory)</label>
                <select name="sub" id="subCategorySelect" class="form-select bg-light">
                    <option value="">सभी उपश्रेणियां</option>
                    <?php foreach ($allSubcategories as $sc): 
                        $scName = !empty($sc['hindi_name']) ? $sc['hindi_name'] : $sc['name'];
                    ?>
            ...
            <div class="col-12 d-flex justify-content-end gap-2 pt-1 border-top mt-3">
                <a href="search.php" class="btn btn-light border px-4 rounded-3 fw-bold small text-muted">रीसेट करें</a>
                <button type="submit" class="btn btn-primary px-4 rounded-3 fw-bold small"><i class="bi bi-funnel-fill me-1"></i>फिल्टर लागू करें</button>
            </div>
        </form>
    </div>
