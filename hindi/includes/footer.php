<!-- OfferPlant 9th Anniversary Footer Banner -->
<footer class="anniversary-badge text-white mt-5">
    <div class="container">
        <div class="row g-4 align-items-center pb-4 border-bottom border-secondary">
            <div class="col-lg-6">
                <div class="d-flex align-items-center mb-3">
                    <span class="badge bg-warning text-dark fw-bold px-3 py-2 fs-6 rounded-pill me-3 shadow">9वीं वर्षगांठ</span>
                    <span class="text-white-50 font-heading fw-bold">26 जुलाई 2017 – 26 जुलाई 2026</span>
                </div>
                <div class="d-flex align-items-center gap-3 mb-2">
                    <img src="<?php echo BASE_URL; ?>assets/logo.png" alt="Saran Index Logo" height="48" class="bg-white p-1 rounded-3 shadow-sm" style="object-fit: contain;">
                    <h4 class="fw-bold mb-0 font-heading text-white">सारण इंडेक्स – सारण को डिजिटली जोड़ते हुए</h4>
                </div>
                <p class="text-white-50 mb-0" style="max-width: 520px; font-size: 0.95rem;">
                    <strong>ऑफ़रप्लांट टेक्नोलॉजीज प्राइवेट लिमिटेड</strong> के 9वें स्थापना दिवस पर लॉन्च। सारण जिले (बिहार) के प्रत्येक प्रखंड, पंचायत, गाँव, व्यवसाय एवं नागरिक को डिजिटल रूप से जोड़ने के लिए समर्पित।
                </p>
            </div>
            <div class="col-lg-6 text-lg-end">
                <div class="d-inline-flex flex-wrap gap-2 justify-content-lg-end">
                    <a href="add-contact.php" class="btn btn-warning rounded-pill px-4 py-2 fw-bold text-dark shadow-sm">
                        <i class="bi bi-rocket-takeoff me-1"></i>मुफ़्त व्यवसाय जोड़ें
                    </a>
                    <a href="emergency.php" class="btn btn-outline-light rounded-pill px-4 py-2 fw-semibold">
                        <i class="bi bi-telephone me-1"></i>आपातकालीन हेल्पलाइन
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 pt-4">
            <div class="col-md-4">
                <h6 class="text-warning text-uppercase fw-bold mb-3 tracking-wide" style="font-size: 0.8rem;">सारण इंडेक्स के बारे में</h6>
                <p class="text-white-50 small mb-3">
                    सारण इंडेक्स सारण जिले (छपरा) की एकमात्र भरोसेमंद डिजिटल निर्देशिका है, जो नागरिकों, व्यापारियों, वकीलों, डॉक्टरों और संस्थानों को एक साथ लाती है।
                </p>
                <div class="small text-white-50 mb-3">
                    <i class="bi bi-building me-1 text-warning"></i> <strong>ऑफ़रप्लांट टेक्नोलॉजीज प्राइवेट लिमिटेड</strong> की एक पहल।
                </div>

                <div class="mt-3">
                    <h6 class="text-warning text-uppercase fw-bold mb-2 tracking-wide" style="font-size: 0.75rem;"><i class="bi bi-share-fill me-1"></i>सोशल मीडिया पर जुड़ें <span class="badge bg-warning text-dark me-1">@saranindex</span></h6>
            ...
            <div class="col-md-4">
                <h6 class="text-warning text-uppercase fw-bold mb-3 tracking-wide" style="font-size: 0.8rem;">त्वरित लिंक एवं कानूनी जानकारी</h6>
                <ul class="list-unstyled small mb-0">
                    <li class="mb-2"><a href="index.php" class="text-white-50 text-decoration-none hover-white"><i class="bi bi-chevron-right me-1 text-warning"></i>मुख्य पृष्ठ (होम)</a></li>
                    <li class="mb-2"><a href="blocks" class="text-white-50 text-decoration-none hover-white"><i class="bi bi-chevron-right me-1 text-warning"></i>सारण के सभी 20 प्रखंड</a></li>
                    <li class="mb-2"><a href="emergency" class="text-white-50 text-decoration-none hover-white"><i class="bi bi-chevron-right me-1 text-warning"></i>24x7 आपातकालीन सेवाएं</a></li>
                    <li class="mb-2"><a href="about" class="text-white-50 text-decoration-none hover-white"><i class="bi bi-chevron-right me-1 text-warning"></i>ऑफ़रप्लांट एवं सारण इंडेक्स के बारे में</a></li>
            ...
            <div class="col-md-4">
                <h6 class="text-warning text-uppercase fw-bold mb-3 tracking-wide" style="font-size: 0.8rem;">मुख्य श्रेणियां</h6>
                <div class="d-flex flex-wrap gap-2 mb-3">
                    <a href="category/businesses-retail-stores" class="btn btn-sm btn-dark text-white-50 border-secondary">व्यापार एवं दुकानें</a>
                    <a href="category/advocates-legal" class="btn btn-sm btn-dark text-white-50 border-secondary">वकील एवं कानूनी</a>
        ...
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-between pt-4 mt-4 border-top border-secondary text-white-50 small">
            <p class="mb-2 mb-md-0">&copy; <?php echo date('Y'); ?> <strong>सारण इंडेक्स</strong>. सर्वाधिकार सुरक्षित। डिज़ाइन एवं संचालित: <a href="http://offerplant.com" target="_blank" class="text-warning text-decoration-none">ऑफ़रप्लांट टेक्नोलॉजीज प्राइवेट लिमिटेड</a></p>
            <div class="d-flex gap-3">
                <a href="privacy-policy" class="text-white-50 text-decoration-none">गोपनीयता नीति</a>
                <span>•</span>
                <a href="terms" class="text-white-50 text-decoration-none">नियम एवं शर्तें</a>
                <span>•</span>
                <a href="refund-policy" class="text-white-50 text-decoration-none">रिफंड नीति</a>
            </div>
        </div>
    </div>
</footer>
