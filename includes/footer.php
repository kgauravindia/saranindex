    ...
    <div class="container relative-z">
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-7">
                    <div class="d-flex align-items-center flex-wrap gap-2 mb-3">
                        <span class="badge bg-warning text-dark fw-bold px-3 py-2 fs-6 rounded-pill shadow-sm"><i class="bi bi-award-fill me-1"></i> 9th Anniversary</span>
                        <span class="text-white-50 font-heading fw-semibold small">26 July 2017 – 26 July 2026</span>
                        <span class="badge bg-info-subtle text-info border border-info rounded-pill px-3 py-1.5 ms-auto ms-sm-0 small">100% Free Public Directory</span>
                    </div>
                    <div class="d-flex align-items-center gap-3 mb-2">
                        <img src="assets/logo.png" alt="Saran Index Logo" width="48" height="48" loading="lazy" decoding="async" class="bg-white p-1 rounded-3 shadow-sm flex-shrink-0" style="object-fit: contain;">
                        <h3 class="fw-bold mb-0 font-heading text-white fs-4">Saran Index – Connecting Saran Digitally</h3>
                    </div>
                    <p class="text-white-50 mb-0" style="max-width: 600px; font-size: 0.95rem; line-height: 1.6;">
                        Launched on the 9th Incorporation Day of <strong>OfferPlant Technologies Private Limited</strong>. Dedicated to digitally connecting every block, panchayat, village, business, hospital, advocate, and citizen of Saran District, Bihar.
                    </p>
                </div>
                <div class="col-lg-5 text-lg-end">
                    <div class="d-inline-flex flex-wrap gap-2 justify-content-lg-end">
                        <a href="add-contact" class="btn btn-warning rounded-pill px-4 py-2.5 fw-bold text-dark shadow d-inline-flex align-items-center gap-2">
                            <i class="bi bi-rocket-takeoff-fill fs-5"></i>List Business Free
                        </a>
                        <a href="emergency" class="btn btn-outline-light rounded-pill px-4 py-2.5 fw-semibold d-inline-flex align-items-center gap-2">
                            <i class="bi bi-telephone-outbound-fill text-warning"></i>Emergency 24x7
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-4 pt-2">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex align-items-center gap-2 mb-3">
                    <img src="assets/logo.png" alt="Saran Index" width="36" height="36" loading="lazy" decoding="async" class="bg-white p-1 rounded-2">
                    <h5 class="fw-bold text-white font-heading mb-0">Saran Index</h5>
                </div>
                <p class="text-white-50 small mb-3" style="line-height: 1.6;">
                    The ultimate trusted digital directory for Saran District (Bihar), bringing together citizens, businesses, doctors, advocates, schools & local administration under one portal.
                </p>
                <div class="small text-white-50 mb-4 p-2.5 rounded-3 bg-dark border border-secondary d-inline-flex align-items-center gap-2 w-100">
                    ...
                    <div>
                        <span class="d-block text-white-50" style="font-size: 0.75rem;">AN INITIATIVE BY</span>
                        <strong class="text-white" style="font-size: 0.85rem;">OfferPlant Technologies Pvt. Ltd.</strong>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6 ps-lg-4">
                <h6 class="footer-heading">Key Verticals</h6>
                <div class="d-flex flex-column gap-2">
                    <a href="category/businesses-retail-stores" class="footer-link">
                        <i class="bi bi-shop text-warning me-1"></i> Businesses & Retail Stores
                    </a>
                    <a href="category/advocates-legal" class="footer-link">
                        <i class="bi bi-briefcase-fill text-warning me-1"></i> Advocates & Legal Services
                    </a>
                    <a href="category/doctors-healthcare" class="footer-link">
                        <i class="bi bi-hospital-fill text-warning me-1"></i> Doctors & Hospitals
                    </a>
                    <a href="category/schools-education" class="footer-link">
                        <i class="bi bi-book-half text-warning me-1"></i> Schools & Colleges
                    </a>
                    <a href="category/government-offices" class="footer-link">
                        <i class="bi bi-building-gear text-warning me-1"></i> Government Offices
                    </a>
                    <a href="category/hotels-restaurants" class="footer-link">
                        <i class="bi bi-cup-hot-fill text-warning me-1"></i> Hotels & Restaurants
                    </a>
                    <a href="emergency" class="footer-link">
                        <i class="bi bi-telephone-fill text-warning me-1"></i> Emergency Helplines
                    </a>
                    <a href="pricing" class="footer-link">
                        <i class="bi bi-star-fill text-warning me-1"></i> Verified Business Plans
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <h6 class="footer-heading">Quick Links & Legal</h6>
                <ul class="list-unstyled mb-0 d-flex flex-column gap-2">
                    ...
                    <li><a href="privacy-policy" class="footer-link"><i class="bi bi-chevron-right text-warning"></i> Privacy Policy</a></li>
                    <li><a href="terms" class="footer-link"><i class="bi bi-chevron-right text-warning"></i> Terms & Conditions</a></li>
                    <li><a href="refund-policy" class="footer-link"><i class="bi bi-chevron-right text-warning"></i> Refund Policy</a></li>
                    <li><a href="contact" class="footer-link"><i class="bi bi-chevron-right text-warning"></i> Contact & Support</a></li>
                    <li><a href="admin/login.php" class="footer-link"><i class="bi bi-shield-lock-fill text-warning"></i> Admin Portal</a></li>
                </ul>
            </div>

            <!-- Column 4: Contact & Support Box -->
            <div class="col-lg-3 col-md-6">
                <h6 class="footer-heading">Contact & District Support</h6>
                <div class="contact-info-card">
                    <div class="d-flex align-items-start gap-2.5 text-white-50 small mb-3">
                        ...
                        <div>
                            <strong class="d-block text-white">Headquarters</strong>
                            <span>Chapra, Saran, Bihar, India - 841301</span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-2.5 text-white-50 small mb-3">
                        ...
                        <div>
                            <strong class="d-block text-white">Email Support</strong>
                    ...
                    <div class="d-flex align-items-center gap-2.5 text-white-50 small mb-3">
                        ...
                        <div>
                            <strong class="d-block text-white">Support Hours</strong>
                    ...
                    <div class="mt-3 text-center">
                        <span class="badge bg-warning-subtle text-warning border border-warning border-opacity-50 rounded-pill fw-semibold px-3 py-1.5" style="font-size: 0.78rem;">
                            <i class="bi bi-shield-check me-1"></i> Private Directory Portal
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                    <h6 class="footer-heading mb-0">
                        <i class="bi bi-geo-alt-fill me-1"></i>Business Directories by Block (All 20 Saran Blocks)
                    </h6>
                    <a href="blocks" class="small text-warning text-decoration-none hover-white"><i class="bi bi-grid-fill me-1"></i>View Block Directory</a>
                </div>
            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2.5">
                    <h6 class="footer-heading mb-0 text-white-50" style="font-size: 0.82rem; letter-spacing: 0.04em;">
                        <i class="bi bi-compass-fill text-warning me-1"></i>Saran District Heritage, Geography & Canal Irrigation Guides
                    </h6>
                </div>
                <div class="d-flex flex-wrap gap-2 text-white-50 small">
                    <a href="history" class="block-pill-chip" title="History & Heritage of Saran District">
                        <i class="bi bi-hourglass-split text-warning"></i> History & Heritage of Saran
                    </a>
                    <a href="river" class="block-pill-chip" title="Rivers of Saran (Ganga, Sarayu, Gandak)">
                        <i class="bi bi-water text-info"></i> Rivers of Saran (Ganga, Sarayu, Gandak)
                    </a>
                    <a href="nahar" class="block-pill-chip" title="Canals & Irrigation Network (Gandak Project)">
                        <i class="bi bi-bezier2 text-success"></i> Canals & Irrigation (Gandak Project)
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-between pt-4 mt-4 border-top border-secondary text-white-50 small gap-3">
            <p class="mb-0 text-center text-md-start">
                &copy; <?php echo date('Y'); ?> <strong>Saran Index</strong>. All Rights Reserved. Designed & Maintained by 
                <a href="http://offerplant.com" target="_blank" class="text-warning text-decoration-none fw-bold">OfferPlant Technologies Pvt. Ltd.</a>
            </p>
            <div class="d-flex align-items-center gap-2">
                <span class="badge bg-dark border border-secondary text-white-50 rounded-pill px-3 py-1.5">
                    <i class="bi bi-heart-fill text-danger me-1"></i> Made for Saran District, Bihar
                </span>
            </div>
            <div class="d-flex gap-3">
                <a href="privacy-policy" class="text-white-50 text-decoration-none footer-link">Privacy Policy</a>
                <span>•</span>
                <a href="terms" class="text-white-50 text-decoration-none footer-link">Terms</a>
                <span>•</span>
                <a href="refund-policy" class="text-white-50 text-decoration-none footer-link">Refund Policy</a>
            </div>
        </div>
    </div>
</footer>
