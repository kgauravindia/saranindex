...
<div class="container">
    ...
    <div class="receipt-container">
        ...
        <div class="invoice-header d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3">
            <div>
                ...
                <div class="text-muted small">
                    ...
                    <strong class="text-dark">An Initiative of OfferPlant Technologies Private Limited</strong>
                </div>
            </div>
        ...
        <div class="text-center text-muted small mt-5 pt-4 border-top">
            ...
            <p class="mb-1 text-dark fw-semibold" style="font-size: 0.85rem;">An Initiative of OfferPlant Technologies Private Limited</p>
